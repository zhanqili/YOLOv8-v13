...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='D:\PycharmProjects\Pytorch_Yolo\yolov9-main\yolov9-main\models\detect\gelan.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'D:\PycharmProjects\Pytorch_Yolo\yolov9-main\yolov9-main\TT100K\TT100K.yaml', help='dataset.yaml path')
